...
public class Match {
	...
	public Match(String league, String startTime, String match_status_minutes, String match_home, String score, String match_away, String match_handicap, String corner, String corner_line, String total_goals, String match_attach, String match_shoot, String live_events, String COL){
		this.league = league; 
	...
	public String toString(){
		return "Match:" + league + " " + startTime  + " " + match_status_minutes + " " + match_home  + " " + score  + " " + match_away  + " " + match_handicap   + " " + corner   + " " + corner_line + " " + total_goals  + " " + match_attach  + " " + match_shoot  + " " + live_events  + " " + COL ; 
	}
}
